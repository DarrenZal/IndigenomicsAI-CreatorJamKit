...
# Speech-Act Bingo Card

Mark a square when the room notices this transition being proposed, assumed, blocked, or clarified.
...
> Transition check: I think this may be `<from>` to `<to>`. Who can authorize that move, and what does it not establish?

## Boundary Squares

These squares are especially important because the correct move may be to stop:
...
Stopping, blocking, or preserving separate still counts as a successful bingo square if the room names the boundary clearly.
