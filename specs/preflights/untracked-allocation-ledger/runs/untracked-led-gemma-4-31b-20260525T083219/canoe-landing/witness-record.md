# Canoe Landing / Witness Record — Untracked Ledger preflight

- packet: `preflight-untracked-allocation`
...
A ledger that records allocations without turning every gift, favor, or relational act into surveillance.
...
Marker-only records named in the packet were not given to the build attempt and were not computed on: private-fields.
