...
- packet: `preflight-bioregion-layers`
...
Filter a multi-layer place-map manifest by consent and produce a layer board.
...
The build attempt produced a tool that passed all 3 acceptance tests.
