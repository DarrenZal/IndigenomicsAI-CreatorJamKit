...
def main():
    ...
    # BOUNDARY section
    output_lines.append("BOUNDARY: This is a receipt of what was computed. It does not offset, certify")
    output_lines.append("carbon neutrality, or grant a reuse license.")
